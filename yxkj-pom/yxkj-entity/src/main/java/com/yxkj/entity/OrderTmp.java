...
/**
 * Entity - 临时订单表，用于保存锁定商品订单
 *
 * @author Andrea
 * @version 2017年9月18日 上午10:42:49
 */
@Entity
@Table(name = "t_order_tmp", indexes = {@Index(name = "sceneIdIndex", columnList = "sceneId"),
    @Index(name = "snIndex", columnList = "sn"),
    @Index(name = "paymentTimeIndex", columnList = "paymentTime")})
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "t_order_tmp_sequence")
